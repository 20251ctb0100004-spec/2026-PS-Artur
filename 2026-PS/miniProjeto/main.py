...
# ------------------ GERAR DATA/HORA ------------------
def gerar_data_hora():
    dia = random.randint(1, 28) # dado no formato int, que vai decidir o dia da consulta, ele é aleatório entre 1 e 28 para que não haja problemas com meses que tem menos de 31 dias
