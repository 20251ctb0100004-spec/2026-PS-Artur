...
print(f'{valor}°C = {temperatura.celsius_para_kelvin(valor):.1f}°K')
print(f'Zero absoluto: {temperatura.ZERO_ABSOLUTO_CELSIUS}°C')

# BLOCO 3: API LIMPA DO PACOTE

from conversores import km_para_milhas, celsius_para_fahrenheit, milhas_para_km, celsius_para_kelvin

print('\n=== api limpa ===')
print(f'100km = {km_para_milhas(100):.2f} milhas')
